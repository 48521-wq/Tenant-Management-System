// Payment model — rent payment records between tenant and landlord
const mongoose = require('mongoose');

const paymentDefinition = new mongoose.Schema({
...
module.exports = mongoose.model('Payment', paymentDefinition);
