// Complaint model — tenant complaints submitted to admin
const mongoose = require('mongoose');

const complaintDefinition = new mongoose.Schema({
...
module.exports = mongoose.model('Complaint', complaintDefinition);
